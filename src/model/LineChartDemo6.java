...
public class LineChartDemo6 extends ApplicationFrame {
    ...
    public LineChartDemo6(final String title) {
        ...
        for(int i=0;i<12;i++){        	
        	data.put(Util.getCalendar(i), i+1);
        }
        
        //final JFreeChart chart = (new JFreeChartExporter()).createLineChart(new AssinanteComponent().getHistoricoConsumoTotalDoAssinante(null, Calendar.getInstance(), Calendar.getInstance()),"Historico","Consumo",null,null);
        final JFreeChart chart = (new JFreeChartExporter()).createPieChart(createPieDataSet(new AssinanteComponent().getAssinantes().get(0)), "Consumo de Recurso Contratado");//createChart(dataset);
        final ChartPanel chartPanel = new ChartPanel(chart);
        chartPanel.setPreferredSize(new java.awt.Dimension(422, 230));
        setContentPane(chartPanel);
    	 
    }
    
	private PieDataset createPieDataSet(entity.Assinante a){
