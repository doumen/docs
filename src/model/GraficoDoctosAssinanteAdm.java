...
public class GraficoDoctosAssinanteAdm implements Serializable {
	...
	public void createPieModel(int[] linePie) {
	...
	public void createLineModels(int[] lineGrafico) {
	...
	public boolean equals(Object obj) {
		if (obj == this)
			return true;
		if (!(obj instanceof GraficoDoctosAssinanteAdm))
			return false;
		GraficoDoctosAssinanteAdm g = (GraficoDoctosAssinanteAdm) obj;
